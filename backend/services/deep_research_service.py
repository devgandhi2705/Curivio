...
The module that used to read these rows for its research_report/
explain_simply actions was deleted by chat-routing v2 (chat_service's
code-run search and chat_router's classifier replaced its routing job;
nothing replaced this particular read).
